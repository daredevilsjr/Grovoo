      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            <a href="/pdfs/privacy-policy.pdf" target="_blank" className="text-gray-400 hover:text-white transition-colors">
              Privacy Policy
            </a>
            <a href="/pdfs/terms-of-service.pdf" target="_blank" className="text-gray-400 hover:text-white transition-colors">
              Terms of Service
            </a>
            <a href="/pdfs/cookie-policy.pdf" target="_blank" className="text-gray-400 hover:text-white transition-colors">
              Cookie Policy
            </a>
            <a href="/pdfs/refund-policy.pdf" target="_blank" className="text-gray-400 hover:text-white transition-colors">
              Refund Policy
            </a>
          </div>
        </div>
